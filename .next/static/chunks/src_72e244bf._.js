...
"[project]/src/app/players/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditPlayerForm({ player, onSave, onCancel }) {
    _s();
    const [name, setName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(player.name);
...
_s(EditPlayerForm, "LHFkVFza7F9JZmoF2XsWrsOZjT0=");
_c = EditPlayerForm;
function PlayersPage() {
    _s1();
    const { players, addPlayer, removePlayer } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    const [editingPlayerId, setEditingPlayerId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleUpdatePlayer = (id, name)=>{
        ...
        const state = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getState();
        const updatedPlayers = state.players.map((player)=>player.id === id ? {
                ...player,
                name
            } : player);
        // Set the new state
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].setState({
...
_s1(PlayersPage, "nFLY8ixF4aIICtVi2ey0rBZXLPY=", false, function() {
    return [
...
_c1 = PlayersPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "EditPlayerForm");
__turbopack_context__.k.register(_c1, "PlayersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_72e244bf._.js.map